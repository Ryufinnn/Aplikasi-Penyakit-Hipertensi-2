...
<div id="header">
  <div id="batasheader">
    <div id="bataskiri"><a href="index.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image2','','logo.jpg',1)"></a></div>
    <div id="batastengah">
    <?php
    if(!empty($_SESSION['user1'])){
		?>
        <p style="color:#FFF"><b>Selamat Datang, <br/>
            <font size="+1"><?php echo $_SESSION[user1]; ?></font></b></p>
        <?php
		}
	?>
	 ...
	 ?>
      ...
      <div id="slider" class="box">
        <div id="slider-holder">
          <ul>
            <li><a href="#"><img src="js/images/5.jpg" alt="" width="1030" height="252"/></a></li>
...
<div id="body">
  <div id="konten">
	<div id="konten-kanan">
    <div class="bar">
    	<p class="style1">Assalamualaikum Wr.Wb</p>
    </div>
    <p>
    <div id="pg">
	<?php
    ...
    <div id="Accordion1" class="Accordion" tabindex="0">
      <div class="AccordionPanel">
        <div class="AccordionPanelTab">Jam</div>
...
<div id="footer" style="color:#FFFFF;"><marquee behavior="alternate"><b><a href="admin" style="text-decoration:none;">Created 2015 By <a href="www.padangwebsite.com">Irawati </a></a></b></marquee></div>
<body>
<script type="text/javascript">
