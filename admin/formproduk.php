...
<form id="form1" name="form1" method="post" action="produkaksi.php" enctype="multipart/form-data">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td>Nama iBrand</td>
      <td><label>
        <select name="idbrand" id="idbrand2">
          <option value="0">Pilih brand</option>
        <?php
				while($rbrand = mysql_fetch_array($sqlbrand)){
					echo "<option value='$rbrand[idbrand]'>$rbrand[namabrand]</option>";
				}
           ?>
    </select>
      </label></td>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td><label>
        ...
        <?php
				while($rbrand = mysql_fetch_array($sqlbrand)){
					if($rbrand['idbrand'] == $rpro['idbrand']){
						echo "<option value='$rbrand[idbrand]' selected>$rbrand[namabrand]</option>";
					}else{
						echo "<option value='$rbrand[idbrand]'>$rbrand[namabrand]</option>";						
					}
				}
