...
//if (!empty($lokasi_file)){  
		...
		include "../koneksi.php";
		mysql_query ("INSERT INTO produk (idkategori, idbrand, namaproduk, deskripsi, harga, stok, tglmasuk, foto) VALUES ( '$_POST[idkategori]', '$_POST[idbrand]', '$_POST[namaproduk]', '$x', '$_POST[harga]', '$_POST[stok]', NOW(), '$nama_file');");
