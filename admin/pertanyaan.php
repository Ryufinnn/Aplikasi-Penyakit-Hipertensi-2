...
<body>
<a href="index.php?pg=20&aksi=add">Tambah</a>
<table border="0" cellpadding="2" cellspacing="2">
<tr bgcolor="#FFFF66">
<td width="50" height="30" align="center" bgcolor="#CCCCCC">NO.</td>
<td width="479" align="center" bgcolor="#CCCCCC">NAMA GEJALA</td>
...
<form method="post" action="insert_gejala.php">
  ...
  <td width="101" align="center"><input type="submit" value=" Simpan " /></td>
  <td width="89" align="center"><input type="button" value=" Batal " onclick="parent.location='index.php?pg=20'" /></td>
</form>
</tr>
<?php
}
...
<tr bgcolor="<?php echo $warna; ?>">
  ...
  <td width="101" align="center"><a href="index.php?pg=20&aksi=edit&id=<?php echo $row[id]; ?>">Edit</a></td>
  <td width="89" align="center"><a href="index.php?pg=20&aksi=del&id=<?php echo $row[id]; ?>" onClick="return confirmdelete('Data ini');">Delete</a></td>
</tr>
<?php
}
