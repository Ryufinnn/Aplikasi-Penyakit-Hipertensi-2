...
<body>
<a href="index.php?pg=21&amp;aksi=add">Tambah</a>
<table border="0" cellpadding="2" cellspacing="2">
<tr bgcolor="#FFFF66">
<td width="50" height="30" align="center" bgcolor="#CCCCCC">NO.</td>
<td width="300" align="center" bgcolor="#CCCCCC">NAMA PENYAKIT</td>
<td width="350" align="center" bgcolor="#CCCCCC">Definisi</td>
<td width="422" align="center" bgcolor="#CCCCCC">Solusi</td>
...
<form method="post" action="insert_penyakit.php">
  ...
  <td width="81" align="center"><input type="submit" value=" Simpan " /></td>
  <td width="71" align="center"><input type="button" value=" Batal " onclick="parent.location='index.php?pg=21'" /></td>
</form>
</tr>
<?php
}
...
<tr bgcolor="<?php echo $warna; ?>">
  ...
  <td width="81" align="center" ><a href="index.php?pg=21&aksi=edit&id=<?php echo $row[id]; ?>">Edit  |</a></td>
  <td width="71" align="center"><a href="index.php?pg=21&aksi=del&id=<?php echo $row[id]; ?>" onClick="return confirmdelete('Data ini');">Delete</a></td>
</tr>
<?php
}
